...
<head>
  ...
  document.getElementsByTagName("td")[0].style.fontFamily=font;
  document.getElementsByTagName("th")[0].style.fontFamily=font;
}
...
function setTextSize(){
  ...
  document.getElementsByTagName("p")[0].style.fontSize= size;
  document.getElementsByTagName("li")[0].style.fontSize= size;
  document.getElementsByTagName("td")[0].style.fontSize= size;
  document.getElementsByTagName("th")[0].style.fontSize= size;
}
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">@yield('AppName')</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="{{ Request::is('panel/dashboard') ? 'nav-link active' : 'nav-link' }}" href="{{ url('panel/dashboard') }}">
        ...
        @if (Auth::check() && Auth::user()->access == 'Employer' && Auth::user()->access == 'Admin')
        <li class="nav-item">
          <a class="{{ Request::is('admin/Clients') ? 'nav-link active' : 'nav-link' }}" href="{{ url('/admin/Clients') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="{{ Request::is('admin/BankCustomerChurnPrediction') ? 'nav-link active' : 'nav-link' }}" href="{{ url('/admin/BankCustomerChurnPrediction') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Customer Prediction</span>
          </a>
        </li>
        @endif
        ...
        @endif
        @if (Auth::check() && Auth::user()->access == 'RH')
        <li class="nav-item">
        <a class="{{ Request::is('panel/employer') ? 'nav-link active' : 'nav-link' }}" href="{{ url('/panel/employer') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="{{ Request::is('http://127.0.0.1:5000/') ? 'nav-link active' : 'nav-link' }}" target="_blank" href="http://127.0.0.1:5000/">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="{{ Request::is('http://127.0.0.1:5000/') ? 'nav-link active' : 'nav-link' }}" target="_blank" href="http://127.0.0.1:5000/">
            ...
            <span class="nav-link-text ms-1">Employer Prediction</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Account</h6>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none">Welcome Home </span>
              </a>
            </li>
...
window.onload = function() {
  ...
  $(document).on('click', "#edit-modal-Employer", function() {
    $(this).addClass('edit-item-trigger-clicked'); //useful for identifying which trigger was clicked and consequently grab data from the correct row and not the wrong one.

    var options = {
      'backdrop': 'static'
    };
    $('#edit-modal-Employer').modal(options)
  })
  ...
  $('#edit-modal-Employer').on('show.bs.modal', function(e) {
    var link     = $(e.relatedTarget),
        modal    = $(this),
        id = link.data("id");
    var Name = link.data("name"),
    ...
    modal.find("#modal-input-id").val(id);
    modal.find("#modal-input-Name").val(Name);
    modal.find("#modal-input-Username").val(Username);
    modal.find("#modal-input-Email").val(email);
    modal.find("#modal-input-Role").val(role);

  })
  // on modal hide
  $('#edit-modal-Employer').on('hide.bs.modal', function() {
    $('.edit-item-trigger-clicked').removeClass('edit-item-trigger-clicked')
    $("#edit-form").trigger("reset");
  })
}
